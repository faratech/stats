...
async def get_service_status():
    services = {
        ...
        # Add other Windows services you want to monitor
    }
    service_status = {}
                ...
                <div class="card">
                    ...
                    <div class="service-list">
                        <div class="service-status">
                            <div><i class="fas fa-print"></i> Print Spooler</div>
                            <span id="service_Print Spooler"><i class="fas fa-spinner"></i></span>
                        </div>
                        <div class="service-status">
                            <div><i class="fas fa-clock"></i> Windows Time</div>
                            <span id="service_Windows Time"><i class="fas fa-spinner"></i></span>
                        </div>
